...
evitarSeleccion(document.body);jQuery(document).ready(function($){$(".scroll").click(function(event){event.preventDefault();$('html,body').animate({scrollTop:$(this.hash).offset().top},800);});});$('.pergunta').click(function(){$('i',this).toggleClass('fa-times').fadeIn('slow');});